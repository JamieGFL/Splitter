...
public class RestGruppenServiceTests {
  ...
  void test_01() {
    ...
    assertThat(service.getRestGruppen()
        .contains(new GruppeEntity("Reisegruppe", List.of("MaxHub", "GitLisa"))));
  }
  ...
  void test_02() {
    ...
    assertThat(service.getRestGruppen()).containsExactlyInAnyOrder(
        new GruppeEntity("Reisegruppe1", List.of("MaxHub", "GitLisa")),
        new GruppeEntity("Reisegruppe2", List.of("GitAndreas", "GitLisa")),
        new GruppeEntity("Reisegruppe3", List.of("GitAndreas", "MaxHub")));
  }
