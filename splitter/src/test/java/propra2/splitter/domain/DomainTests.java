...
public class DomainTests {
    ...
    void test_010(){
        ...
        assertThat(transaktionen.get(0).getTransaktionsNachricht().equals(transaction1_0)|| transaktionen.get(0).getTransaktionsNachricht().equals(transaction1_1)).isTrue();
        assertThat(transaktionen.get(1).getTransaktionsNachricht().equals(transaction2_0)|| transaktionen.get(1).getTransaktionsNachricht().equals(transaction2_1)).isTrue();
    }
    ...
    void test_011(){
        ...
        System.out.println(transaktionen.stream().map(Transaktion::getTransaktionsNachricht).toList());
